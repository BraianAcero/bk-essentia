export default function PrivacyPolicyPage() {
  return (
    <div className="container mx-auto px-4 py-12">
      <h1 className="text-4xl font-serif font-bold text-black mb-8">Privacy Policy</h1>
      ...
      <div className="prose max-w-none">
        ...
        <p className="mb-4">
          At BK ESSENTIA, we respect your privacy and are committed to protecting your personal data. This privacy
        ...
        <p className="mb-4">
          Email: privacy@bkessentia.com
          <br />
          Phone: +1 (123) 456-7890
          <br />
          Address: 123 Fragrance Avenue, Perfume City, PC 12345
        </p>
      </div>
    </div>
  )
